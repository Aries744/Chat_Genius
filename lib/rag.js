...
async function storeMessageEmbedding(messageId) {
    try {
...
async function querySimilarMessages(query, limit = 5) {
    try {
...
async function generateAIResponse(query, similarMessages) {
    try {
